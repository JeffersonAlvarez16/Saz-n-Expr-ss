...
export const metadata: Metadata = {
  title: "Sazón Expréss - Comida Casera por WhatsApp",
  description: "Plataforma de venta de comida casera con pedidos por WhatsApp",
};

// Intenta inicializar la base de datos al cargar la aplicación
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              <Link href="/" className="flex items-center">
                <span className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-green-500 to-teal-600">
                Sazón Expréss
                </span>
              </Link>
              ...
              <nav className="hidden md:flex space-x-8">
                ...
                <Link href="/productos" className="font-medium hover:text-green-600 transition-colors">
                  Productos
                </Link>
            ...
            <div className="md:flex md:items-center md:justify-between">
              ...
              <div className="mt-8 md:mt-0">
                <p className="text-center md:text-right text-gray-500 text-sm">
                  &copy; {new Date().getFullYear()} Sazón Expréss - Comida casera con amor
                </p>
              </div>
            </div>
          </div>
